...
import { getUserToken } from "./bridge-method";
...
const App = () => {
  ...
  // useEffect(() => {
  //   if (fetchedUser && bannedList.includes(fetchedUser.id)) {
  //     navigate("/banned");
  //   } else {
      ...
      .then((r) => {
        ...
        bridge
          ...
          .then(async (res) => {
            ...
            // const result = await fetch(
            //   "https://176.119.159.157:1467/upload-photo",
            //   {
            //     method: "POST",
            //     token: userToken,
            //     photoNumber: 1,
            ...
            const result = await axios({
              method: "POST",
              url: "https://ods-studio.ru/my-summer/upload-photo",
              token: userToken,
              photoNumber: 1,
            });
