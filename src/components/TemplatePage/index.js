  ...
  useEffect(() => {
    switch (name) {
      ...
      case "search":
        ...
        const groupIdWoman = getGroupId.msgSearchPageWoman
          ? getGroupId.msgSearchPageWoman
          : WOMAN_GROUP_ID_MAILING_SEARCH;
      ...
      case "result":
        ...
        const subMan = getGroupId.subResultPageMan
          ? getGroupId.subResultPageMan
          : MAN_GROUP_ID_MAILING_SEARCH;

        const subWoman = getGroupId.subResultPageWoman
